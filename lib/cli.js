...
const { viewDepts, viewRoles, viewByDept, viewByManager, viewEmployees, addDept, addRole, addEmployee, updateEmployee, deleteEmployee, deleteRole, deleteDept } = require('./sql');
        ...
        .prompt([
            {
                ...
                choices: ['View All Employees', 'Add Employee', 'Update Employee Role', 'View All Roles', 'Add Role', 'View All Departments', 'Add Department', 'View Employee by Department', 'View Employee by Manager', 'Delete From Database']
            },
        ])
        .then(({ landing }) => {
            switch (landing) {
...
// Need to move get functions outside to avoid repeating
