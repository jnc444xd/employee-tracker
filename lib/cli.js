...
const { viewDepts, viewRoles, viewByDept, viewByManager, viewEmployees, addDept, addRole, addEmployee, updateEmployee, deleteEmployee, deleteRole, deleteDept, viewBudget } = require('./sql');
