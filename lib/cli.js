...
const { viewDepts, viewRoles, viewByDept, viewEmployees, addDept, addRole, addEmployee, updateEmployee } = require('./sql');
        ...
        .prompt([
            {
                ...
                choices: ['View All Employees', 'Add Employee', 'Update Employee Role', 'View All Roles', 'Add Role', 'View All Departments', 'Add Department', 'View Employee by Department']
            },
        ])
        .then(({ landing }) => {
            switch (landing) {
