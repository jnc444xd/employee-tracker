...
const { viewDepts, viewRoles, viewByDept, viewByManager, viewEmployees, addDept, addRole, addEmployee, updateEmployee } = require('./sql');
        ...
        .prompt([
            {
                ...
                choices: ['View All Employees', 'Add Employee', 'Update Employee Role', 'View All Roles', 'Add Role', 'View All Departments', 'Add Department', 'View Employee by Department', 'View Employee by Manager']
            },
        ])
        .then(({ landing }) => {
            switch (landing) {
